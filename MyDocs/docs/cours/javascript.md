...
- Création d'in formulaire de saissie de données.
...
En informatique, une variable est un conteneur qui stocke la données temporairement au sein de notre code.
...
### 4. Regrouper des donnees grace aux tableaux

---

## Partie [2]. Ecrire notre premier fichier javascript

---

## Partie [3]. Faire intéragir javascript avec une page web

---


## Partie [4]. FCréation d'un formulaire de saisie de données
